...
function RegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.firstname) {
            ...
            newErrors.firstname = "Invalid First Name. Please enter at least 2 letters.";
            hasErrors = true;
        }
        ...
        if (!formData.lastname) {
            ...
            newErrors.lastname = "Invalid Last Name. Please enter at least 2 letters.";
            hasErrors = true;
        }

        // Validate phone number
        if (!formData.phone_number) {
            newErrors.phone_number = "Enter your phone number";
            hasErrors = true;
        } else if (!regex.phone.test(formData.phone_number)) {
            newErrors.phone_number = "Invalid phone number. Format should start with 09 and have 11 digits.";
            hasErrors = true;
        } else if (phoneNumbersList.includes(formData.phone_number)) {
        ...
        if (!formData.secondary_phone_number) {
            newErrors.secondary_phone_number = "Enter your alternative phone number";
            hasErrors = true;
        } else if (!regex.phone.test(formData.secondary_phone_number)) {
            newErrors.secondary_phone_number = "Invalid alternative phone number format.";
            hasErrors = true;
        } else if (phoneSecondaryNumbersList.includes(formData.secondary_phone_number)) {
            newErrors.secondary_phone_number = "Alternative phone number is already registered";
            hasErrors = true;
        } else if (formData.phone_number === formData.secondary_phone_number) {
            newErrors.secondary_phone_number = "Alternative phone number must be different from primary phone number";
            hasErrors = true;
        }
        ...
        if (!formData.password) {
            ...
            newErrors.password = "Password must contain 8-30 characters, including letters and numbers.";
            hasErrors = true;
        }
