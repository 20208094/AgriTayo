        ...
        <div className="min-h-screen bg-gradient-to-br from-[rgb(182,244,146)] to-[rgb(51,139,147)] flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-md w-full backdrop-blur-lg bg-opacity-90">
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-gray-800 mb-2">Edit Alternative Number</h1>
                    <p className="text-gray-600 mb-6">Update your secondary contact information</p>
                    ...
                    {!isClicked ? (
                        <div className="space-y-4">
                            <div className="relative">
                                <input
                                    type="text"
                                    placeholder="Enter new alternative number"
                        ...
                        <div className="space-y-4">
                            <p className="text-gray-600 mb-4">
                                ...
                                <span className="font-semibold block">{newSecondaryPhone}</span>
                            </p>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-center text-lg tracking-wider"
                                />
                                {otpError && (
