...
function LandingPage() {
  ...
  const scrollToMembers = () => {
    devTeamRef.current?.scrollIntoView({ behavior: 'smooth' });
  };
  ...
  return (
    <div className="bg-gradient-to-b from-[#E6F5E1] to-[#ffffff] flex flex-col">
      ...
      <section ref={aboutSection} className="py-16" style={{ backgroundImage: `url(${bg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="flex justify-center items-center">
          <button onClick={scrollToMembers} className="mt-8 bg-[#00B251] text-white p-4 rounded-full hover:bg-[#008F41] transition duration-300 transform hover:scale-105 shadow-lg flex items-center">
