...
const CompleteButton = styled(TouchableOpacity, 'bg-[#50d71e] py-3 rounded-lg justify-center items-center mt-4');
...
function CheckOutScreen() {
  ...
  const totalPrice = checkedOutItems.reduce((total, item) => total + item.price * item.quantity, 0);
