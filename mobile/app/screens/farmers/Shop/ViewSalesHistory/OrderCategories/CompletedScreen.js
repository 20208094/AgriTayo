        ...
        {completedOrders.map((completedOrder) => (
          ...
          >
            ...
            <Text className="text-md text-gray-600">
              Order completed on: {formatDate(completedOrder.completed_date)} at{" "}
              {formatTime(completedOrder.completed_date)}
            </Text>
                  ...
                  >
                    <View className="flex-1">
                      ...
                      <View className="flex-row mt-2">
                        <Text className="w-1/3 text-sm text-gray-600">
                          Total Quantity:
                        </Text>
                        <Text className="text-sm text-gray-600">
                          {item.order_prod_total_weight}{" "}
                          {item.orig_prod_metric_symbol}
                        </Text>
                      </View>
