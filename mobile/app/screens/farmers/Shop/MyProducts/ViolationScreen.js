    ...
    try {
      ...
      if (storedData) {
        ...
        const filteredViolationItems = crops.filter(
          (crop) =>
            crop.availability === "violation" && crop.shop_id === shop.shop_id
        );
            ...
            <View className="flex-1">
              ...
              <View className="mb-1">
                <Text className="text-xs font-medium text-green-600">
                  ...
                  <Text className="text-gray-800">
                    {violationItem.category
                      ? violationItem.category.crop_category_name
                      : "Unknown"}
                  </Text>
                </Text>
                </View>
                ...
                <Text className="text-xs font-medium text-green-600">
                  Subcategory:{" "}
                  <Text className="text-gray-800">
                    {violationItem.subcategory
                      ? violationItem.subcategory.crop_sub_category_name
                      : "Unknown"}
                  </Text>
                </Text>
              </View>
              ...
              <View className="mb-1">
                <Text className="text-xs font-medium text-green-600">
                  Variety:{" "}
                  <Text className="text-gray-800">
                    {violationItem.variety
                      ? violationItem.variety.crop_variety_name
                      : "Unknown"}
                  </Text>
                </Text>
                </View>
                ...
                <Text className="text-xs font-medium text-green-600">
                  ...
                  <Text className="text-gray-800">
                    {violationItem.size
                      ? violationItem.size.crop_size_name
                      : "Unknown"}
                  </Text>
                </Text>
                </View>
                ...
                <Text className="text-xs font-medium text-green-600">
                  Class:{" "}
                  <Text className="text-gray-800">
                    {violationItem.crop_class || "Unknown"}
                  </Text>
                </Text>
              </View>
              ...
              <View className="mb-1">
                ...
                <Text className="text-xs font-medium text-[#00B251]">
                  Negotiation:{" "}
                  <Text className="text-gray-800">
                    {violationItem.negotiation_allowed
                      ? "Allowed"
                      : "Not Allowed"}
                  </Text>
                </Text>
              ...
              <View className="flex-row justify-between">
                <Text className="text-xs font-medium text-green-600">
                  Weight:{" "}
                  <Text className="text-gray-800">
                    {violationItem.metric
                      ? `${violationItem.metric.metric_system_name}`
                      : "Unknown"}
                  </Text>
                </Text>
