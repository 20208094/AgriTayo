...
import { View, Text, ScrollView, TouchableOpacity, SafeAreaView, Modal, TextInput, Button, Alert } from "react-native";
          ...
          <View key={shippingOrder.order_id} className="p-4 mb-6 bg-white border border-[#00B251] rounded-lg shadow-md">
            ...
            <View className="mt-4">
              ...
              <View className="flex-col mt-2">
                ...
                >
                  <Text className="text-white text-center font-bold">No, I refused to recieve my order.</Text>
                </TouchableOpacity>
              </View>
            </View>
