    ...
    try {
      ...
      if (response.ok) {
        ...
        const sortedStatuses = updatedStatuses.sort(
          (a, b) => a.order_status_id - b.order_status_id
        );
      ...
      <View className="bg-green-200 py-3 rounded-b-lg">
        <View className="flex-row items-center px-4">
          <View className="relative mr-4">
            <Image
              source={{ uri: userData.user_image_url }}
              className="w-24 h-24 rounded-full"
            />
            <View className="absolute bottom-0 right-0 bg-green-600 rounded-full"></View>
          </View>
          <View>
      ...
      <View className="px-4 mt-2">
        <View className="bg-white rounded-lg shadow p-4 space-y-4">
          ...
          <TouchableOpacity
            className="flex-row items-center justify-between"
            onPress={() =>
              navigation.navigate("Buyer Negotiation List", { userData })
            }
          >
            <View className="flex-row items-center">
          ...
          <TouchableOpacity
            className="flex-row items-center justify-between"
            onPress={() => navigation.navigate("My Bids", { userData })}
          >
            <View className="flex-row items-center">
          ...
          {!shopData ? (
            <TouchableOpacity
              className="flex-row items-center justify-between"
              onPress={() =>
                navigation.navigate("Welcome To Agritayo!", { userData })
              }
            >
              <View className="flex-row items-center">
                <Icon
          ...
          <TouchableOpacity
            className="flex-row items-center justify-between"
            onPress={() => navigation.navigate("Customer FAQ")}
          >
            <View className="flex-row items-center">
              <Icon
                name="address-book"
