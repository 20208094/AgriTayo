                ...
                <View className="px-4 py-6">
                    ...
                    <View className="border-b border-gray-300 pb-4 mb-4">
                        <Image
                            ...
                            resizeMode="cover"
                        />
                        <Text className="text-xl md:text-2xl font-semibold text-gray-800 mb-2">
                        ...
                        <Text className="text-lg md:text-xl font-bold text-[#00B251]">
                        ...
                        <View className="flex-1 justify-center items-center bg-gray-600 bg-opacity-25">
                            <View className="bg-white w-4/5 p-6 rounded-lg">
                                ...
                                <ScrollView className="mb-4">
                                    <Text className="text-sm md:text-base text-gray-600">{dummyNegotiation[0].productDescription}</Text>
                                </ScrollView>
                                <TouchableOpacity
