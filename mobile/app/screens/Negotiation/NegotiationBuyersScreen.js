...
import { SafeAreaView, View, Text, TouchableOpacity, TextInput, Image, Switch, Modal } from 'react-native'
    ...
    return (
        <StyledSafeAreaView className="flex-1 p-5 bg-white">
            ...
            <StyledView className="mb-6 items-center">
                <Image source={dummyNegotiation[0].productImage} className="w-40 h-40" />
            ...
            {/* Total */}
            <StyledText className="text-lg font-bold mb-4 text-black">Total: ₱ {total}</StyledText>

            {/* New Toggle Switch */}
            <StyledView className="flex-row items-center mb-4">
                <StyledText className="text-lg font-bold text-black">Open for:</StyledText>
                ...
                >
                    ...
                    >
                        <StyledView
                            className={`absolute top-[2px] start-[2px] h-[20px] w-[20px] rounded-full transition-transform duration-300 ${isChecked ? 'translate-x-[20px] bg-white' : 'translate-x-0 bg-gray-400'}`}
                        />
                    </StyledView>
                </StyledTouchableOpacity>
                <StyledText className="text-lg font-bold text-black">    Negotiation</StyledText>
            </StyledView>
            ...
            >
                <StyledText className="text-center text-white font-bold">Create Negotiate</StyledText>
            </StyledTouchableOpacity>
            ...
            >
                <StyledView className="flex-1 justify-center items-center bg-black/50">
                    <StyledView className="w-4/5 p-6 bg-white rounded-lg shadow-lg items-center">
                        <StyledText className="text-xl font-bold text-black mb-4">Are you sure?</StyledText>
                        ...
                        <StyledView className="flex-row justify-between w-full">
                            ...
                            >
                                <StyledText className="text-center text-black font-bold">No</StyledText>
                            </StyledTouchableOpacity>
                            <StyledTouchableOpacity
                                className="flex-1 ml-2 bg-green-600 p-4 rounded-lg"
                                onPress={handleConfirmYes}
                            >
                                <StyledText className="text-center text-white font-bold">Yes</StyledText>
                            </StyledTouchableOpacity>
                        </StyledView>
                    </StyledView>
                </StyledView>
            ...
            >
                <StyledView className="flex-1 justify-center items-center bg-black/50">
                    <StyledView className="w-4/5 p-6 bg-white rounded-lg shadow-lg items-center">
                        <StyledText className="text-xl font-bold text-green-600 mb-4">Negotiation Successful!</StyledText>
                        <StyledText className="text-base text-gray-600 mb-6">
                            You have successfully negotiated. The seller will review your offer.
                        </StyledText>
                        <StyledTouchableOpacity
                            className="w-full bg-green-600 p-4 rounded-lg"
                            onPress={() => setModalVisible(false)}
                        >
                            <StyledText className="text-center text-white font-bold">Okay</StyledText>
                        </StyledTouchableOpacity>
                    </StyledView>
                </StyledView>
            </StyledModal>
