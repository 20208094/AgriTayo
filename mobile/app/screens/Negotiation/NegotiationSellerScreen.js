...
import { SafeAreaView, View, Text, TouchableOpacity, TextInput, Image, Modal, Dimensions } from 'react-native';
                ...
                <View className="px-1 py-1">
                    <View className="border-b border-gray-300 pb-4 mb-1">
                        ...
                        <Text className="text-sm text-gray-600 mb-2">
                            {isReadMore
                                ? `${dummyNegotiation.productDescription.substring(0, 50)}${shouldShowReadMore ? '...' : ''}`
                        ...
                        <View className="flex-row justify-between space-x-4 mt-1">
                            ...
                            <View className="flex-1 border border-[#00B251] rounded-md p-4">
                                ...
                                <View className="space-y-4">
                                    ...
                                    />
                                    <Text className={`${dynamicTextSize} font-bold text-gray-800`}>
                                        Total: ₱{total}
                                    </Text>
                                    <TouchableOpacity
